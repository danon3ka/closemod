            ...
            const rules = [
                ...
                },
                {
                    ...
                    content: `
                        ...
                        <p class="tab-indent"><span class="bg-color-commands">/ban ID 1d 1.17</span> в канале <span class="bg-color-channels"># ✏・запись</span> или <span class="bg-color-channels"># 🔧┇для-клоз-команд</span>.</p>
                ...
                },
                {
                    ...
                    content: `
                        ...
                        <div>
                            ...
                            <p class="tab-indent">2. Переходим в канал <span class="bg-color-channels"> # ⚪┇logs-closemod</span>.</p>
                            <p class="tab-indent">3. Используем комбинации <span class="grey-bg-kbd">Ctrl + F</span> и <span class="grey-bg-kbd">Ctrl + V</span>.</p>
                            <p><span class="color-yellow">Дополнительно:</span> Сообщить <span class="color-red">модерации</span> о нарушении в нашем общем канале <span class="bg-color-channels"> # <span class="circle green"></span>┇чат</span>.</p>
                            <p>При необходимости показать откат с ситуацией в одном из голосовых каналов <span class="bg-color-channels"> 🔊 <span class="circle green"></span> Приват #1-3</span>.</p>
                        </div>
            ...
            const notes = [
                {
                    ...
                    content: `
                        ...
                        <p>Общие правила проекта распространяются так же и на вас как  <span class="bg-color-closemaker">@• Клозмейкеров</span>, любое нарушение правил влечет за собой наказание от  <span class="color-vugovor"><span class="circle red"></span> выговора</span> до  <span class="color-red">блокировки</span> на сервере.</p>
                    `
                },
                {
                ...
                },
                {
                    ...
                    content: `
                        ...
                        <div>
                            <h2>⛔ Запреты:</h2>
                            <p class="tab-indent"><span class="circle orange"></span> Превышение полномочий;</p>
                            <p class="tab-indent"><span class="circle orange"></span> Использование полномочий в личных целях;</p>
                            <p class="tab-indent"><span class="circle red"></span> Распространение любой админ информации;</p>
                            <p class="tab-indent"><span class="circle yellow"></span> Игнорирование нарушений коллег;</p>
                            <p class="tab-indent"><span class="circle yellow"></span> Игнорирование нарушений пользователей;</p>
                            <p class="tab-indent"><span class="circle red"></span> Пропуск собраний без уважительной причины;</p>
                            <p class="tab-indent"><span class="circle orange"></span> Неисполнение обязанностей;</p>
                            <p class="tab-indent"><span class="circle red"></span> Несоблюдение основных правил сервера;</p>
                            <p class="tab-indent"><span class="circle yellow"></span> Несправедливая, нерациональная и необдуманная выдача наказаний;</p>
                            <p class="tab-indent"><span class="circle yellow"></span> Несоблюдение профессиональной этики с участниками;</p>
                            <p class="tab-indent"><span class="circle yellow"></span> Несоблюдение субординации;</p>
                            <p class="tab-indent"><span class="circle orange"></span> Обман вышестоящего;</p>
                            <p class="tab-indent"><span class="circle yellow"></span> Использование статуса "не беспокоить";</p>
                            <p class="tab-indent"><span class="circle yellow"></span> Неактивность во время созданного клоза;</p>
                            ...
                            <p>Перед каждым пунктом указано <b>минимальное наказание</b>, но это не гарантирует его применение, все зависит от ситуации. Особые нарушения караются от <span class="color-vugovor"><span class="circle red"></span> Выговор</span> до <span class="color-red">бана</span> на сервере.</p>
                            <div class="divider"></div>
                            <h2>🛑 Прочие запреты:</h2>
                            <p class="tab-indent"><span class="circle orange"></span> Пинговать роль <span class="bg-color-close">@Close</span> в <span class="bg-color-channels"># ✏・запись</span> чаще, чем раз в <b>30 минут</b>.*</p>
                            <p class="tab-indent"><span class="circle yellow"></span> Пинговать роль <span class="bg-color-close">@Close</span> в <span class="bg-color-channels"># ✏・запись</span>, когда нужен <b>+1</b>.*</p>
                            ...
                            <p class="tab-indent"><span class="circle orange"></span> Пинговать роль <span class="bg-color-close">@Close</span> в <span class="bg-color-channels"># 💬┇общение</span> чаще, чем раз в <b>60 минут</b>.*</p>
                            <p class="tab-indent"><span class="circle orange"></span> Приглашать людей в <span class="bg-color-channels"># 💬┇общение</span> на клоз без пинга роли <span class="bg-color-close">@Close</span> чаще, чем раз в <b>30 минут</b>.</p>
                            <p class="tab-indent"><span class="circle orange"></span> Использовать команду <span class="bg-color-commands">/клоз</span> чаще, чем раз в <b>30 минут</b>. Так же недопускаем два embed сообщения с клозом подряд.</p>
                            ...
                            <p">За неоднократное нарушение вы можете получить <span class="color-pred"><span class="circle orange"></span> Предупреждение</span> или <span class="color-vugovor"><span class="circle red"></span> Выговор</span> с причиной <b>"нарушение прочих запретов"</b>.</p>
                        </div>
                        `
                        },
...

                        {
                            ...
                            content: `
                                <div>
                                    ...
                                    <p class="tab-indent"><strong>1.</strong> Игрок предыдущего матча (не более 3 игр подряд);</br><strong>2.</strong> Игрок из первого слота брони;</br><strong>3.</strong> Рандомный игрок присоединившийся к записи, приоритет у того, кто в данный момент в войсе.</p>
                                    ...
                                    <div class="bg-notes-frame">
                                        <span class="color-red">ВАЖНО!</span> Нарушение этих правил запрещено и влечет за собой последствия от <span class="color-beseda"><span class="circle yellow"></span> Замечание</span> до <span class="color-vugovor"><span class="circle red"></span> Выговор</span>.
                                    </div></br>
...

                        {
                            ...
                            content: `
                                <div>
                                    ...
                                    <div class="bg-notes-frame">
                                        <span class="color-red">ВАЖНО!</span> Нарушение данных правил влечет за собой внутренние наказания от <span class="color-beseda"><span class="circle yellow"></span> Замечание</span> до <span class="color-vugovor"><span class="circle red"></span> Выговор</span> с причиной «Игнорирование правил создания доп. клозов».
                                    </div></br>
...

                        {
                            ...
                            content: `
                                <div>
                                    ...
                                    <div class="bg-notes-frame">
                                        <span class="color-red">ВАЖНО!</span> За подобные нарушения вы будете получать внутренние наказания от <span class="color-beseda"><span class="circle yellow"></span> Замечание</span> до <span class="color-vugovor"><span class="circle red"></span> Выговор</span>.
                                    </div>
